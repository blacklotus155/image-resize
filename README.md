...
```
cd existing_repo
git remote add origin https://gitlab.com/gus.affand/imageresizego.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/gus.affand/imageresizego/-/settings/integrations)
